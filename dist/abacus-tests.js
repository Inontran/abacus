...
document.addEventListener('DOMContentLoaded', function () {
    ...
    describe('getPosFromValue', function () {
        ...
        for (var i = 0; i < arrAbacusSetValues.length; i++) {
            _loop_1(i);
        }
    });
    ...
    describe('roundValuePerStep', function () {
        ...
        for (var i = 0; i < arrSetValues.length; i++) {
            _loop_2(i);
        }
    });
    describe('set animate property', function () {
        ...
        for (var i = 0; i < arrTestValues.length; i++) {
            _loop_3(i);
        }
    });
    ...
    describe('set orientation property', function () {
        var model = new Model_1.Model();
        var arrTestValues = ['1', true, null, 'qwe', 2, undefined, 'vertical', 'horizontal'];
        var arrRightValues = ['horizontal', 'horizontal', 'horizontal', 'horizontal', 'horizontal', 'horizontal', 'vertical', 'horizontal'];
...
/******/ })()
;
//# sourceMappingURL=abacus-tests.js.map?v=d24cea345fb9b9563410